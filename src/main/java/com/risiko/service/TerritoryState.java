...
public class TerritoryState {
    ...
    public void setArmate(int armate) { this.armate = Math.max(1, armate); }

    public void addArmate(int n)    { this.armate += n; }
    public void removeArmate(int n) { this.armate = Math.max(1, this.armate - n); }
